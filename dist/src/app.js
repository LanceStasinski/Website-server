...
app.use("/landing-page", express_1.default.static(path_1.default.resolve(__dirname, "public/landing-page", "index.html")));
app.use("/my-first-blog", express_1.default.static(path_1.default.resolve(__dirname, "public/blog", "index.html")));
